...
moh_for_mutalyzer<-moh_for_mutalyzer%>%select(-c(ethnicity,locality))%>%distinct()
...
write.table(final_moh_variants,file='./output/preconception_screening_moh_202202.csv',sep='\t',row.names=F,quote=F)
```